export const env = {
  ...
  mqttMonthlyCleanupEnabled: (process.env.MQTT_MONTHLY_CLEANUP_ENABLED || 'yes').toLowerCase() !== 'no',
  mqttMonthlyCleanupDay: Number(process.env.MQTT_MONTHLY_CLEANUP_DAY || 1),
  mqttMonthlyCleanupHour: Number(process.env.MQTT_MONTHLY_CLEANUP_HOUR || 3),
